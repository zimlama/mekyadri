...
const { REACT_APP_GET_ALL_USERS, REACT_APP_FRONT, REACT_APP_POST_HOTELS } =
  process.env;
...
export default function CreateHotelIbera() {
  ...
  function handleSubmit(e) {
    ...
    if (!input.name || !input.city || !input.stars) {
      ...
      axios
        .post(REACT_APP_POST_HOTELS, input)
        ...
        >
          <Stack spacing={4}>
            ...
            <Text color={"gray.500"} fontSize={{ base: "sm", sm: "md" }}>
              We're looking for amazing hotels with fabulous destinations! Add a
              new hotel and increase the Ibera experience!
            </Text>
          </Stack>
          <FormControl>
            <Box as={"form"} mt={10}>
              ...
              <HStack>
                ...
                <Link to="/home">
                  <Button marginLeft="1rem">Return</Button>
                </Link>
              </HStack>
            </Box>
          </FormControl>
...
export const Blur = (IconProps) => {
  const breakpoint3 = useBreakpointValue({
    base: "100%",
    md: "40vw",
    lg: "30vw",
  });
