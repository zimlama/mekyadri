...
const {
  ...
  REACT_APP_FRONT,
  REACT_APP_MODIFY_HOTELS,
  REACT_APP_MODIFY_ROOMS,
} = process.env;
  ...
  if (render === "") {
    ...
    const handleFilterHotel = (e) => {
      ...
      const StateFilterHotel = stateHotel.filter((h) => {
        return h.name
          .toLowerCase()
          .includes(inputFilterHotel.value.toLowerCase());
      });
    ...
    const SubmitModifyHotel = (e) => {
      if (
        ...
        if (
          !inputHotelForm.name ||
          !inputHotelForm.address ||
          !inputHotelForm.city ||
          !inputHotelForm.description ||
          !inputHotelForm.stars
        ) {
          setErrorSubmit("error");
        } else {
          axios
            .put(
              `${REACT_APP_MODIFY_HOTELS}${newHotel[0].idHotels}`,
              inputHotelForm
            )
    ...
    if (
      inputHotelForm.stars.length === 1 &&
      !isNaN(inputHotelForm.stars) &&
        ...
        <div>
          ...
          >
            ...
            <Select
              ...
              borderWidth="3px"
              maxW="sm"
              onChange={handleSelectChangeHotel}
            >
              {stateHotel &&
                stateHotel.map((h) => {
                ...
                <Card maxW="sm">
                  <CardBody>
                    ...
                    <Stack mt="6" spacing="3">
                      ...
                      <Text>Name: {newHotel[0].name}</Text>
                      <Text>City: {newHotel[0].city}</Text>
                      <Text>Address: {newHotel[0].address}</Text>
                      <Text>Description: {newHotel[0].description}</Text>
                      <Text>Stars: {newHotel[0].stars}</Text>
                    </Stack>
                  </CardBody>
                  <Divider />
                </Card>
              ...
              <div>
                <FormControl>
                  ...
                  <Input
                    ...
                    name="name"
                    borderWidth="3px"
                    value={inputHotelForm.name}
                    onChange={handleFormChangeHotel}
                  />
                  {!errorNsuccessful ? (
                    <FormHelperText>Name should have 3 letters.</FormHelperText>
                  ) : (
                  ...
                  <Input
                    ...
                    name="city"
                    borderWidth="3px"
                    value={inputHotelForm.city}
                    onChange={handleFormChangeHotel}
                  />
                  {!errorCsuccessful ? (
                    <FormHelperText>City should have 3 letters.</FormHelperText>
                  ) : (
                    <FormErrorMessage></FormErrorMessage>
                  )}
                  {errorCsuccessful ? (
                  ...
                  <Input
                    ...
                    name="description"
                    borderWidth="3px"
                    value={inputHotelForm.description}
                    onChange={handleFormChangeHotel}
                  />
                  {!errorDsuccessful ? (
                    <FormHelperText>
                  ...
                  <Input
                    ...
                    name="stars"
                    borderWidth="3px"
                    value={inputHotelForm.stars}
                    onChange={handleFormChangeHotel}
                  />
                  {!errorSsuccessful ? (
                    <FormHelperText>
                      Stars should have 1 number. Less than 6 and greater than 0
                    </FormHelperText>
                  ) : (
                    <FormErrorMessage></FormErrorMessage>
                  )}
    ...
    const handleFilterRoom = (e) => {
      ...
      const StateFilterRoom = stateRoom.filter((h) => {
        return h.name
          .toLowerCase()
          .includes(inputFilterRoom.value.toLowerCase());
      });
    ...
    const SubmitModifyRoom = (e) => {
      if (
        ...
        if (
          ...
          axios
            .put(
              `${REACT_APP_MODIFY_ROOMS}${newRoom2[0].idRooms}`,
              inputRoomForm
            )
            .then((res) => console.log(res))
            .catch((err) => console.log(err));
    ...
    if (
      inputRoomForm.bed_quantity.length === 1 &&
      !isNaN(inputRoomForm.bed_quantity) &&
      inputRoomForm.bed_quantity > 0 &&
      inputRoomForm.bed_quantity < 6
    ) {
              ...
              >
                <Card maxW="sm">
                  <CardBody>
                    ...
                    <Stack mt="6" spacing="3">
                      <Heading size="md">Hotle Information</Heading>
                      <Text>Name: {newRoom[0].name}</Text>
                      <Text>City: {newRoom[0].city}</Text>
                      <Text>Address: {newRoom[0].address}</Text>
                      <Text>Description: {newRoom[0].description}</Text>
                      <Text>Stars: {newRoom[0].stars}</Text>
                    </Stack>
                  </CardBody>
                  <Divider />
                </Card>
              ...
              >
                <Card maxW="sm">
                  <CardBody>
                    ...
                    <Stack mt="6" spacing="3">
                      <Heading size="md">Hotle Information</Heading>
                      <Text>Name: {newRoom2[0].name}</Text>
                      <Text>Price: {newRoom2[0].price}</Text>
                      <Text>Description: {newRoom2[0].description}</Text>
                      <Text>Bed_quantity: {newRoom2[0].bed_quantity}</Text>
                    </Stack>
                  </CardBody>
                  <Divider />
                </Card>
              ...
              <div>
                <FormControl>
                  ...
                  <Input
                    ...
                    name="bed_quantity"
                    borderWidth="3px"
                    value={inputRoomForm.bed_quantity}
                    onChange={handleFormChangeRoom}
                  />
                  {!errorBedSuccessful ? (
                    <FormHelperText>
                      Bed_quantity should have 1 number. Less than 6 and greater
                      than 0
                    </FormHelperText>
                  ) : (
                    <FormErrorMessage></FormErrorMessage>
                  ...
                  <Input
                    ...
                    name="description"
                    borderWidth="3px"
                    value={inputRoomForm.description}
                    onChange={handleFormChangeRoom}
                  />
                  {!errorDesSuccessful ? (
                    <FormHelperText>
