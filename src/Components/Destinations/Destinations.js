...
const {
  ...
  REACT_APP_FRONT,
  REACT_APP_DISABLE_USERS,
  REACT_APP_DELETE_HOTELS,
  REACT_APP_DISABLE_HOTELS,
  REACT_APP_DELETE_ROOMS,
  REACT_APP_DISABLE_ROOMS,
} = process.env;
...
function DeleteUser() {
  ...
  if (render === "") {
    ...
    const handeleEnableDisable = (e) => {
      axios
        .put(REACT_APP_DISABLE_USERS, { email: newUser[0].email })
    ...
    const DeleteHotel = (e) => {
      axios
        .delete(`${REACT_APP_DELETE_HOTELS}${newHotel[0].idHotels}`)
        .then((res) => console.log(res))
        .catch((err) => console.log(err));
    ...
    const DisableHotel = (e) => {
      axios
        .put(`${REACT_APP_DISABLE_HOTELS}${newHotel[0].idHotels}`)
        .then((res) => console.log(res))
        .catch((err) => console.log(err));
    ...
    const DeleteRoom = (e) => {
      axios
        .delete(`${REACT_APP_DELETE_ROOMS}${newRoom2[0].idRooms}`)
        .then((res) => console.log(res))
        .catch((err) => console.log(err));
    ...
    const DisableRoom = (e) => {
      axios
        .put(`${REACT_APP_DISABLE_ROOMS}${newRoom2[0].idRooms}`)
        .then((res) => console.log(res))
        .catch((err) => console.log(err));
